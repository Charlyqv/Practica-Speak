...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permission_crate_category  = Permission::create(['name' => 'create categories']);
        ...
        $permissions_admin = [
            $permission_create_role, $permission_read_role, 
            $permission_update_role, $permission_delete_role, $permission_create_lesson,
            $permission_read_lesson, $permission_update_lesson, $permission_delete_lesson, 
            $permission_crate_category, $permission_read_category, $permission_update_category, 
